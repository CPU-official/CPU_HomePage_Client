...
const awardsData = [
  { id: 1, image: award9, date: "2024.05.10", title: "봉사상", person: "전유림" },
  { id: 2, image: award3, date: "2024.05.31", title: "관악구 표창장", person: "이소리" },
  { id: 3, image: award2, date: "2024.08.06", title: "앱잼 장려상", person: "이소리", appName: "워커쉴드" },
  { id: 4, image: award1, date: "2024.08.08", title: "제 14회 e-ICON 3위", person: "이소리", appName: "SkillSprint" },
  { id: 5, image: award5, date: "2024.11.25", title: "미소챌 개발부문 2위", person: "전유림", appName: "너겟" },
  { id: 6, image: award6, date: "2024.11.25", title: "미소챌 기획부문 3위", person: "전유림" },
  { id: 7, image: award10, date: "2024.12.07", title: "Global Skills 2024 수료증", person: "전유림" },
  { id: 8, image: award4, date: "2024.12.12", title: "교감능력 상", person: "전유림" },
  { id: 9, image: award11, date: "2024.12.22", title: "앱잼 최우수상", person: "전유림", appName: "HousePick" },
  { id: 10, image: award12, date: "2025.01.23", title: "교과 우수상", person: "이소리" },
  { id: 11, image: award7, date: "2025.06.02", title: "과학독후감대회 우수상", person: "전유림" },
  { id: 12, image: award8, date: "2025.07.21", title: "전교회장 당선증", person: "전유림" },
...
const OverlayText = styled.div`
  transform: ${({ $selected }) => ($selected ? `scale(${1 / 1.2})` : "scale(1)")};
  transform-origin: center;
        ...
        <Slide $paused={!!selectAward}>
          <Group>
            {loopData.map((award, index) => {
              ...
              return (
                <Card key={`${award.id}-${index}`} $selected={selected}>
                  <ImageWrapper>
                    <Image
                      src={award.image}
                      alt={award.title}
